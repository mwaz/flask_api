...
def make_app(config_name):
    ...
    app.add_url_rule('/flask_api/v1/auth/register', view_func=user_registration_view, methods=['POST'])
    app.add_url_rule('/flask_api/v1/auth/login', view_func=user_login_view, methods=['POST'])
